...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig_LLAMA_RobustnessCheck_SR_Train_Set_vs_L_[Change_L].pdf}
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig_LLAMA_RobustnessCheck_SR_Validation_Set_vs_L_[Change_L].pdf}
