...
,
$
where $\mathbb{I}_{\tilde{\mathfrak d}}$ maps an element $d\in\tilde{\mathfrak d}$ to its position in $\tilde{\mathfrak d}$ and $\mathbb{I}_{\tilde{\mathfrak d}}$ does the inverse operation. 
}
%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%----------------------------------------------------
\input{tab_KMeans_Cluster_Mapping_Traded_Clusters.tex}
%----------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%----------------------------------------------------
\input{tab_LLAMA_Cluster_Mapping_Extended.tex}
%----------------------------------------------------
%\mx 
%\hspace{0.5cm}
...
\centering
\includegraphics[scale=0.44]{fig_KMeans_Portfolio_Cum_Returns_(L=4,theta=0.5k).pdf}
\end{subfigure}
...
\centering
\includegraphics[scale=0.44]{fig_LLAMA_Portfolio_Cum_Returns_(L=4,theta=0.5k).pdf}
\end{subfigure}
...
\textbf{KMeans}. 
%In \cref{fig:portfolio_returns_comparison} Panel A we plot the cumulative returns of the portfolio constructed based on our KMeans clustering of embeddings. In Panel A of \cref{tab:portfolio_statistics_gross_comparison} we summarize the associated portfolio statistics. 
...
%\begin{figure}[H]
%  \centering
%    \caption{Cumulative Gross Returns of $\mathcal{P}_{\t{KMeans}}$ across data splits for embeddings-based clustering}
...
%----------------------------------------------------
\input{tab_Portfolio_Statistics_Comparison_GROSS.tex}
%----------------------------------------------------
...
\mx
\textbf{LLM}. 
%In \cref{fig:portfolio_returns_comparison} Panel B we plot the cumulative returns of the portfolio based on LLM clustering ($\mathcal P_{LLM}$). 
...
%\begin{figure}[H]
%  \centering
%    \caption{Cumulative Gross Returns of $\mathcal P_{LLM}$ across data splits for LLM-based clustering}
