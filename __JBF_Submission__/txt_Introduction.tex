...
%----------------------------------------------------
%<THIS TEXT IS NOT WELL CONNECTED TO THE REST: IMPROVE>
...
Our methodology consists of defining a schema with which we guide an LLM to detect 
