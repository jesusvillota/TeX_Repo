...
\centering
\includegraphics[scale=0.44]{fig_7a_KMeans_Portfolio_Cum_Returns_(L=4,theta=0.5k).pdf}
\end{subfigure}
...
\centering
\includegraphics[scale=0.44]{fig_7b_LLAMA_Portfolio_Cum_Returns_(L=4,theta=0.5k).pdf}
\end{subfigure}
