...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \centering
        \includegraphics[scale=0.48]{LLAMA_Cluster_Distribution.pdf}
        \label{fig:all_data}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        ...
        \centering
        \includegraphics[width=\textwidth]{LLAMA_Cluster_Distribution_Train.pdf}
        \label{fig:train_data}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\textwidth}
        \caption{Validation data ($\D^{val}$)}
        \centering
        \includegraphics[width=\textwidth]{LLAMA_Cluster_Distribution_Validation.pdf}
        \label{fig:val_data}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\textwidth}
        \caption{Test data ($\D^{test}$)}
        \centering
        \includegraphics[width=\textwidth]{LLAMA_Cluster_Distribution_Test.pdf}
        \label{fig:test_data}
    \end{subfigure}
