...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig_2a_EDA_Histogram_of_Number_of_News_Articles_per_day.pdf}
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig_2b_EDA_Number_of_Words_per_Article.pdf}
