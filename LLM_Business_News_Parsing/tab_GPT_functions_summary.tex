...
\hline
 & 1.1. \texttt{firm} & \qquote{Iterate over each firm in \texttt{firms}} & \texttt{string}
 \tabularnewline
\cline{2-4} \cline{3-4} \cline{4-4} 
 & 1.2. \texttt{ticker} & \qquote{State the stock market ticker of this firm} & \texttt{string}
 \tabularnewline
\cline{2-4} \cline{3-4} \cline{4-4} 
 & 1.3. \texttt{shock\_type} & \qquote{What type of shock does the article imply on this firm?} & \{demand, supply, financial, \newline technology, policy\}\tabularnewline
\cline{2-4} \cline{3-4} \cline{4-4} 
 & 1.4. \texttt{shock\_magnitude} & \qquote{How much impact is the shock expected to have on this firm?} & \{minor, major\}\tabularnewline
\cline{2-4} \cline{3-4} \cline{4-4} 
 & 1.5. \texttt{shock\_direction} & \qquote{In what direction is the shock expected to impact this firm?} & \{positive, negative\}\tabularnewline 
\cline{2-4} \cline{3-4} \cline{4-4} 
\end{tabular}
%}
\begin{tablenotes}
