...
%----------------------------------------------------
\input{EDA_Articles_by_SplitSummary_Statistics.tex}
%----------------------------------------------------
...
\begin{figure}[H]
  ...
  \includegraphics[scale=0.496]{EDA_WordCloud.pdf}
  \label{fig:WordCloud}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \includegraphics[width=\textwidth]{EDA_Histogram_of_Number_of_News_Articles_per_day.pdf}
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \includegraphics[width=\textwidth]{EDA_Number_of_Words_per_Article.pdf}
...
\begin{figure}[H]
  ...
  \includegraphics[scale=0.445]{EDA_Time_Series_of_Articles.pdf}
